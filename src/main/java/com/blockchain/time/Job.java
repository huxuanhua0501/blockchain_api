...
//import com.blockchain.service.impl.BoxStatusService;
...
//        String url = "http://y.xlchina.cn:2000/od/placelist.aspx?flag=gets&_search=false&nd=1545827205763&rows=6000&page=1&sidx=&sord=asc&cname=PlaceName&type=like&word=&dg=0&mediaName=&aroundEnv=&thestate=-1";
//        try {
//            Set<String> set = new HashSet<>();
//            List<Map<String, Object>> mapList = new ArrayList<>();
//
//            String str = HttpUtils.HttpPost(map, url);
////            String str = HttpUtils.httpGet(url);
//            JSONArray jsonArray = JSONObject.parseObject(str).getJSONArray("rows");
//
//            for (int i = 0; i < jsonArray.size(); i++) {
//                JSONObject json = jsonArray.getJSONObject(i);
//                set.add(json.getString("PlaceName"));
//            }
//           set.remove("");
//            Set<String> isSet = new HashSet<>();
//            for (String roadName : set) {
//                map.put("placeName", roadName);
//                url = "http://y.xlchina.cn:2002/orm/EmptyPoint.aspx";
//                str = HttpUtils.HttpPost(map, url);
//                jsonArray = JSONObject.parseObject(str).getJSONArray("rows");
//
//                for (int i = 0; i < jsonArray.size(); i++) {
//
//                    JSONObject json = jsonArray.getJSONObject(i);
...
//                    if (isSet==null){
//                        isSet.add(json.getString("boardid")+json.getString("boardcode"));
//                        mapList.add(insertMap);
//
//                    }else if(!isSet.contains(json.getString("boardid")+json.getString("boardcode"))){
//                        isSet.add(json.getString("boardid")+json.getString("boardcode"));
//                        mapList.add(insertMap);
//
//                    }
